...
docker exec -it -e WINDOW_TITLE="${WINDOW_TITLE}" opensimrt_ros_devel gosu rosopensimrt bash -l -c "source /catkin_ws/devel/setup.bash && roslaunch acquisition_of_raw_data no_app.launch"
