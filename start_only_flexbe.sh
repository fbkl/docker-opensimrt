...
docker exec -it -e WINDOW_TITLE="${WINDOW_TITLE}" opensimrt_ros_devel gosu rosopensimrt bash -l -c "export ELECTRON_ENABLE_HARDWARE_ACCELERATION=1 && source /catkin_ws/devel/setup.bash && rosrun flexbe_app run_app"
